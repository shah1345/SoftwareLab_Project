...
<head>
  ...
  white-space: pre-wrap; /* Keeps the content on a single line nowrap */
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel"> I'm Thinking...... </h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>

<lottie-player src="https://assets1.lottiefiles.com/private_files/lf30_GjhcdO.json"  background="transparent"  speed="1"  style="width: 400px; height: 400px;" loop  autoplay></lottie-player>
    ...
    <div class="main-wrapper main-wrapper-1">
              ...
              <div class="dropdown-list-content dropdown-list-icons">
                <a href="#" class="dropdown-item dropdown-item-unread"> <span
                    ...
                    clean it! <span class="time">17 Hours Ago</span>
												...
												fa-bell"></i>
                  </span> <span class="dropdown-item-desc">SHAH GPT <span class="time">Yesterday</span>
                  </span>
                </a>
              </div>
              <div class="dropdown-footer text-center">
      ...
      <div class="main-sidebar sidebar-style-2">
        <aside id="sidebar-wrapper">
          ...
          <ul class="sidebar-menu">
            ...
            <li class="menu-header">SHAH X</li>
            <li class="dropdown">
                  ...
                  <div class="chat">
                    <div class="chat-header clearfix">
                      ...
                      <div class="chat-about">
                        <div class="chat-with">Fairy of Heaven</div>
                        <div class="chat-num-messages">5 new messages</div>
                      </div>
                    </div>
                  </div>
      ...
      <footer class="main-footer">
        <div class="footer-left">
          <a href="templateshub.net">Developed By Shah Newaz</a></a>
        </div>
